...
console.log(arr.slice(-2)); // last 2 elements of an array
console.log(arr.slice(-1));
console.log(arr.slice(1, -2)); // [b, c]
console.log(arr.slice()); // all the elements from the array
...
console.log(arr);
arr.splice(1, 2);
console.log(arr); // splice deleted the oter ones from the array so it does mutate the original arrayh
...
// CONCAT
const letters = arr.concat(arr2); // arr + arr2 and makes it a single array
console.log(letters);
...
console.log(arr.flat()); // removes the nested arrays, and turned it into a single array

const arrDeep = [[[1, 2], 3], [4, [5, 6]], 7, 8];
// console.log(arrDeep.flat()); // deeply nested arrays wont work with flat()
console.log(arrDeep.flat(2)); // now it goes to the second level of nesting
...
// Numbers
console.log(movements);
// console.log(movements.sort()); // sort works based on strings
...
const numDeposits1000 = accounts
  .flatMap(acc => acc.movements)
  .reduce((count, cur) => (cur >= 1000 ? ++count : count), 0); // count++ doesnt work
...
// console.log(++a); // 11
console.log(a++); // 10 // na de operatie word hij pas aangepast
console.log(a); // 11
...
const sarahDog = dogs.find(dog => {
  ...
  if (dogSarah && dog.curFood > dog.recommendedFood * 1.1) {
    console.log('Your dog is eating too much');
  } else if (dogSarah && dog.curFood < dog.recommendedFood * 0.9) {
